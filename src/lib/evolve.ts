...
export const WAVE_2026: WaveCard[] = [
  ...
  },
  {
    ...
    name: "Apertus 70B",
    lab: "Swiss AI",
    job: "Fully open EU multilingual stack",
    license: "Apache-2.0",
    ours: "Admit the open-data EU job. Silhouette stays Khipu. Not an Apertus twin.",
    status: "HOLOGRAM",
    admit: "apertus",
    note: "Open weights + open data. Still not ours to host as a trophy.",
  },
  {
    id: "ling30",
    name: "Ling-3.0-Flash",
    lab: "inclusionAI",
    job: "Sparse flash coding / finance class",
    license: "MIT",
    ours: "Admit the flash job. Not a Ling dump. Finance scores UNAVAILABLE.",
    status: "HOLOGRAM",
    admit: "flash",
    note: "MIT announced. Vendor numbers stay vendor-reported.",
  },
  {
    id: "v4vision",
    name: "V4-Flash-Vision",
    lab: "DeepSeek",
    job: "Flash multimodal reasoning",
    license: "MIT",
    ours: "Text through the gate. Vision occupancy UNAVAILABLE. Not a pixel product.",
    status: "HOLOGRAM",
    admit: "v4flash",
    note: "Same refuse as other vision seats. No invented VQA score.",
  },
  {
    id: "mistral4s",
    name: "Mistral Small 4",
    lab: "Mistral",
    job: "European small Apache class",
    license: "Apache-2.0",
    ours: "Laptop-class EU job. Serve Khipu. Not a Small-4 rehost.",
    status: "HOLOGRAM",
    admit: "mistral3",
    note: "Sibling of Large 3. Clean license. Still a silhouette.",
  },
  {
    id: "olmo",
    name: "OLMo",
...
export const LINEAGE: LineageNode[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "Apertus 70B", honesty: "HOLOGRAM · EU open-data job, dump refused" },
    ],
